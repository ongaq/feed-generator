...
const strongGameKeywords = [
  ...
  'ピノコニー', '仙舟',
  '天才クラブ', 'スクリューガム', 'ポルカ(・)?カカム', '静寂の主', 'ロードオブサイレンス', 'セセルカル', 'イリアスサラス', '原始博士', '余清塗', '柏環',
  ...
  // v2.3キーワード
  '椒丘', '江戸星', 'アゲートの世界|メルスタイン', 'ガラス光帯', 'パトレヴィニツィア',
  '演武典礼', '飛霄', '懐炎', '雲璃', '伝説の新人剣士', '焔輪八葉', 'オーナメント抽出', '(周期|通常)演算',
  '永遠の地|オンパロス', '小鳥マッチ',
  // v2.4キーワード
  '歩離人', '燼滅(軍団|禍祖)',
  // v2.5キーワード
  ...
  'マダム(・|•)?ヘルタ',
  // v3.0キーワード
  'オクヘイマ', '遂願樹脂', '変数サイコロ', '黄金裔', 'ミュリオン', '(紛争|世を背負う|大地|理性|浪漫|歳月|法|死|詭術|天空|海洋)(」)?のタイタン',
  '(キメラ|ライオン)組', 'アザラシ大作戦', 'セファリア', 'ヒア丹', '丹ヒア', 'アグサフェ', 'サフェアグ', 'アグセファ', 'セファアグ', '火を追う旅',
  // v3.4キーワード
  'NeiKos496', 'PhiLia093', 'OreXis945', 'EpieiKeia216', 'SkeMma720', 'δ(-)?me13', 'カスライナ', '皇帝のセプター',
  '風焔', '鉄墓', '星嘯', '鋳王', '誅羅',
  // v3.5キーワード
  '長夜月', '剣旗卿', '騰荒', '荒笛', 'ザンダー(・|•)?ワン(・|•)?クワバラ', '迷境食堂',
  'セドゥニラモ星群', 'スティーブン(・)?ロイド', '無漏浄子',
  // v4.0キーワード
  '二相楽園', '虚照', '不死途', '緋英', '千星シティ',
  // 音楽
  ...
  '(?<![ァ-ヶー・\\p{sc=Han}])(曜青|ながよづき|アッハタイム|ニカドリー|ジョーリア|モネータ|オロニクス|タレンタム|ファジェイナ|ケファレ|アフリート|ヘレクトラ|ポポン|セーバル|トリビー|トリアン|トリノン|トリスビアス|キュレネ|アナイクス|アナクサゴラス|ヒアンシー|モーディス|サフェル|キャストリス|ファイノン|セイレンス|ケリュドラ)(ママ)?(?![ァ-ヶー・])',
  // 敬称
  '(?<![ァ-ヶー・•\\p{sc=Han}])(サンポ|御空|リンクス|ナターシャ)(ママ|さん|ちゃん|くん|様)',
  'ヨウおじ',
];
const destiny = [
...
const ambiguousKeywords = [
  'マネーウォーズ', 'ヒバナー',
  '(?<![ァ-ヶー・\\p{sc=Han}])(スタレ|ダリア|アグライア|カリュプソー|ナターシャ|サンポ|ギャラガー|ミーシャ|トパーズ|ライコス|アベンチュリン|ザンダー|イドリラ|アッハ|ミュトゥス|クリフォト|ヌース|テルミヌス|ウロボロス|カフカ|ジェパード|ルサカ|ブラックスワン|クラーラ|ホタル|アスター|ブローニャ|ヴェルト|ゼーレ|ヘルタ|フォフォ|アーラン)(?![ァ-ヶー・])',
  '姫子', '銀狼', '黄泉', '景元', '彦卿', '停雲', '乱破', '霊砂', '薬師', '光逝',
  ...destiny, '純美', '死水', '白露', '羅刹', '御空', '阿茶', 'フク郎', '火花',
];
...
const BAN_USER = [
  ...
  'did:plc:6f34jwkmddk6prtgw2zt52kk',
  ...
  'did:plc:76bkasyy75s7pomgw4vjnskj',
];
