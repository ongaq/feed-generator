...
const strongGameKeywords = [
  ...
  '(?<![ァ-ヶー・\\p{sc=Han}])(ながよづき|アッハタイム|ニカドリー|ジョーリア|モネータ|オロニクス|タレンタム|ファジェイナ|ケファレ|アフリート|ヘレクトラ|ポポン|セーバル|トリビー|トリアン|トリノン|トリスビアス|キュレネ|アナイクス|アナクサゴラス|ヒアンシー|モーディス|サフェル|キャストリス|ファイノン|セイレンス|ケリュドラ)(ママ)?(?![ァ-ヶー・])',
  // 敬称
