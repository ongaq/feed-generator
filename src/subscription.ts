...
const matchPatterns = [
  ...
  '(?<![ァ-ヶー・\\p{sc=Han}])(スタレ|モゼ|ジェイド|ギャラガー|カフカ|ヘルタ|ロビン|アスター|フォフォ|ヴェルト|セーバル|アーラン|ホタル)(ママ)?(?![ァ-ヶー・])',
  // 汎用的なキャラ名はハッシュタグ付きのみ
  '#(hsr|モゼ|姫子|トパーズ(＆カブ)?|フック|ペラ|ミーシャ|白露|カフカ|刃|サンポ|ヴェルト|羅刹|御空|ゼーレ|リンクス|クラーラ|ナターシャ|ルカ|ホタル|花火|黄泉)\\s',
  // 敬称
