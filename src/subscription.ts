...
const strongGameKeywords = [
  ...
  'マダム(・|•)?ヘルタ',
  // v3.0キーワード
  'アグライア', 'オクヘイマ', '遂願樹脂', '変数サイコロ', '黄金裔', 'ミュリオン', '(紛争|世を背負う|大地|理性|浪漫|歳月|法|死|詭術|天空|海洋)(」)?のタイタン',
...
const ambiguousKeywords = [
  '(?<![ァ-ヶー・\\p{sc=Han}])(スタレ|カリュプソー|ナターシャ|リンクス|サンポ|ギャラガー|ミーシャ|トパーズ|ライコス|アベンチュリン|ザンダー|イドリラ|アッハ|ミュトゥス|クリフォト|ヌース|テルミヌス|ウロボロス|カフカ|ジェパード|ルサカ|ブラックスワン|クラーラ|ホタル|アスター|ブローニャ|ヴェルト|ゼーレ|ヘルタ|フォフォ|アーラン)(?![ァ-ヶー・])',
