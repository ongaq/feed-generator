...
const strongGameKeywords = [
  ...
  '(?<![ァ-ヶー・\\p{sc=Han}])(ながよづき|ヘレクトラ|ポポン|セーバル|トリビー|トリアン|トリノン|トリスビアス|キュレネ|アナイクス|アナクサゴラス|ヒアンシー|モーディス|サフェル|キャストリス|ファイノン|セイレンス|ケリュドラ|カリュプソー)(ママ)?(?![ァ-ヶー・])',
  // 敬称
  '(?<![ァ-ヶー・•\\p{sc=Han}])(白露|サンポ|羅刹|御空|リンクス|ナターシャ)(ママ|さん|ちゃん|くん|様)',
  'ヨウおじ',
];
const destiny = [
  '虚無', '均衡', '秩序', '繁殖', '開拓', '神秘', '貪慾', '愉悦', '記憶', '調和', '豊穣', '知恵', '壊滅', '刃', 'ロビン',
];
