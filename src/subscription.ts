...
const strongGameKeywords = [
  ...
  '(?<![ァ-ヶー・\\p{sc=Han}])(セーバル|トリビー|トリアン|トリノン|トリスビアス|キュレネ|アナイクス|アナクサゴラス|ヒアンシー|モーディス|サフェル|キャストリス|ファイノン|セイレンス|ケリュドラ|カリュプソー)(ママ)?(?![ァ-ヶー・])',
  // 敬称
  '(?<![ァ-ヶー・•\\p{sc=Han}])(白露|サンポ|羅刹|御空|リンクス|ナターシャ)(ママ|さん|ちゃん|くん|様)',
  'ヨウおじ',
];
const destiny = [
  '虚無', '均衡', '秩序', '繁殖', '開拓', '神秘', '貪慾', '愉悦', '記憶', '調和', '豊穣', '知恵', '壊滅', '刃',
];
// 曖昧なキーワード（他コンテンツと被る可能性）
const ambiguousKeywords = [
  'スタレ',
  'ブローニャ', 'ヴェルト', '姫子', '銀狼', 'ゼーレ', 'ヘルタ', 'フォフォ', 'アーラン',
  'ホタル', 'クラーラ', '花火', '黄泉', 'ブラックスワン', 'ルサカ',
  '景元', '彦卿', '停雲', 'ジェパード', 'カフカ', '乱破',
  'ウロボロス', 'テルミヌス', 'ヌース', 'クリフォト', '薬師',
  ...destiny, '純美',
  'ミュトゥス', 'アッハ', 'イドリラ',
  '死水', 'アベンチュリン', 'ライコス',
  'ロビン', 'アスター', 'トパーズ', 'ミーシャ', '白露', 'ギャラガー',
