...
const matchPatterns = [
  ...
  'マダム(・|•)?ヘルタ',
  // v3.0キーワード？
  'アグライア', 'オクヘイマ', '遂願樹脂', '変数サイコロ', '黄金裔', 'ミュリオン', 'ニカドリー', '紛争(」)?のタイタン',
  // 音楽
  ...
  '(?<![ァ-ヶー・\\p{sc=Han}])(スタレ|モゼ|ギャラガー|カフカ|ヘルタ|ロビン|アスター|フォフォ|ヴェルト|セーバル|アーラン|ホタル|トリビー|キュレネ|アナイクス|ヒアンシー|モーディス|サフェル|キャストリス|ファイノン|セイレンス|ケリュドラ)(ママ)?(?![ァ-ヶー・])',
  // 汎用的なキャラ名はハッシュタグ付きのみ
