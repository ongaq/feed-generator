...
const strongGameKeywords = [
  ...
  '(?<![ァ-ヶー・\\p{sc=Han}])(ながよづき|ヘレクトラ|ポポン|セーバル|トリビー|トリアン|トリノン|トリスビアス|キュレネ|アナイクス|アナクサゴラス|ヒアンシー|モーディス|サフェル|キャストリス|ファイノン|セイレンス|ケリュドラ)(ママ)?(?![ァ-ヶー・])',
  // 敬称
...
const ambiguousKeywords = [
  ...
  'サンポ', '羅刹', '御空', 'リンクス', 'ナターシャ', 'ジェイド', 'カリュプソー',
];
