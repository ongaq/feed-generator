...
const ambiguousKeywords = [
  'マネーウォーズ', 'ヒバナー',
  '(?<![ァ-ヶー・\\p{sc=Han}])(スタレ|ダリア|アグライア|カリュプソー|ナターシャ|リンクス|サンポ|ギャラガー|ミーシャ|トパーズ|ライコス|アベンチュリン|ザンダー|イドリラ|アッハ|ミュトゥス|クリフォト|ヌース|テルミヌス|ウロボロス|カフカ|ジェパード|ルサカ|ブラックスワン|クラーラ|ホタル|アスター|ブローニャ|ヴェルト|ゼーレ|ヘルタ|フォフォ|アーラン)(?![ァ-ヶー・])',
